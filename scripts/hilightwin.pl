...
#
# renamed window "hilight" to "highlight" --nico
#
...
%IRSSI = (
    ...
    name        => "hilightwin",
    description => "Print hilighted messages to window named \"highlight\"",
...
sub sig_printtext {
    ...
    if(
        ...
        $window = Irssi::window_find_name('highlight');
...
$window = Irssi::window_find_name('highlight');
Irssi::print("Create a window named 'highlight'") if (!$window);
